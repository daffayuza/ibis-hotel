...
@section('content')
                    ...
                    <div class="card-header border-0">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="/tipekamar-backend/create" class="btn btn-sm btn-primary">Tambah</a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-center dropdown-menu-arrow">
                                                <a class="dropdown-item" href="/tipekamar-backend/{{$tipekamar->id}}/edit">
                                                    <button type="button" class="btn btn-success">Edit</button>
                                                </a>
                                                    <form action="tipekamar-backend/{{$tipekamar->id}}" method="post">
                                                        @method('DELETE')
                                                        @csrf
    ...
    {{$tipekamars->links('pagination::bootstrap-5')}}
